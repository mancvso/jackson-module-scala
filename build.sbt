...
libraryDependencies ++= Seq(
    ...
    "com.fasterxml.jackson.core" % "jackson-core" % "2.7.2-SNAPSHOT",
    "com.fasterxml.jackson.core" % "jackson-annotations" % "2.7.2-SNAPSHOT",
    "com.fasterxml.jackson.core" % "jackson-databind" % "2.7.2-SNAPSHOT",
    "com.fasterxml.jackson.module" % "jackson-module-paranamer" % "2.7.1",
    // test dependencies
    "com.fasterxml.jackson.datatype" % "jackson-datatype-joda" % "2.7.1" % "test",
    "com.fasterxml.jackson.datatype" % "jackson-datatype-guava" % "2.7.1" % "test",
    "com.fasterxml.jackson.module" % "jackson-module-jsonSchema" % "2.7.1" % "test",
